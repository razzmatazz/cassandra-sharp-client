              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    ColumnOrSuperColumn _elem57 = new ColumnOrSuperColumn();
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            oprot.WriteFieldBegin(field);
            {
              ...
              foreach (ColumnOrSuperColumn _iter58 in Success)
              {
                _iter58.Write(oprot);
              }
              oprot.WriteListEnd();
              ...
              if (field.Type == TType.Map) {
                {
                  ...
                  for( int _i64 = 0; _i64 < _map63.Count; ++_i64)
                  {
                    ...
                    {
                      _val66 = new List<ColumnOrSuperColumn>();
                      TList _list67 = iprot.ReadListBegin();
                      for( int _i68 = 0; _i68 < _list67.Count; ++_i68)
                      {
                        ColumnOrSuperColumn _elem69 = new ColumnOrSuperColumn();
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            oprot.WriteFieldBegin(field);
            {
              ...
              foreach (byte[] _iter70 in Success.Keys)
              {
                oprot.WriteBinary(_iter70);
                {
                  oprot.WriteListBegin(new TList(TType.Struct, Success[_iter70].Count));
                  foreach (ColumnOrSuperColumn _iter71 in Success[_iter70])
                  {
                    _iter71.Write(oprot);
                  }
                  oprot.WriteListEnd();
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            oprot.WriteFieldBegin(field);
            {
              ...
              foreach (byte[] _iter80 in Success.Keys)
              {
                oprot.WriteBinary(_iter80);
                oprot.WriteI32(Success[_iter80]);
              }
              oprot.WriteMapEnd();
            }
            oprot.WriteFieldEnd();
      ...
      public void Write(TProtocol oprot) {
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            {
              oprot.WriteListBegin(new TList(TType.Struct, Success.Count));
              foreach (KeySlice _iter84 in Success)
              {
                _iter84.Write(oprot);
              }
              oprot.WriteListEnd();
      ...
      public void Write(TProtocol oprot) {
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            {
              oprot.WriteListBegin(new TList(TType.Struct, Success.Count));
              foreach (KeySlice _iter88 in Success)
              {
                _iter88.Write(oprot);
              }
              oprot.WriteListEnd();
              ...
              if (field.Type == TType.Map) {
                {
                  ...
                  {
                    byte[] _key91;
                    Dictionary<string, List<Mutation>> _val92;
                    _key91 = iprot.ReadBinary();
                    {
                      _val92 = new Dictionary<string, List<Mutation>>();
      ...
      public void Write(TProtocol oprot) {
        ...
        if (Mutation_map != null && __isset.mutation_map) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (byte[] _iter100 in Mutation_map.Keys)
            {
              oprot.WriteBinary(_iter100);
              {
                oprot.WriteMapBegin(new TMap(TType.String, TType.List, Mutation_map[_iter100].Count));
                foreach (string _iter101 in Mutation_map[_iter100].Keys)
                {
                  oprot.WriteString(_iter101);
                  {
                    oprot.WriteListBegin(new TList(TType.Struct, Mutation_map[_iter100][_iter101].Count));
                    foreach (Mutation _iter102 in Mutation_map[_iter100][_iter101])
                    {
          ...
          if (Success != null) {
            ...
            oprot.WriteFieldBegin(field);
            {
              ...
              foreach (string _iter110 in Success.Keys)
              {
                ...
                {
                  oprot.WriteListBegin(new TList(TType.String, Success[_iter110].Count));
                  foreach (string _iter111 in Success[_iter110])
                  {
      ...
      public void Write(TProtocol oprot) {
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            {
              oprot.WriteListBegin(new TList(TType.Struct, Success.Count));
              foreach (KsDef _iter115 in Success)
              {
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TokenRange _elem118 = new TokenRange();
      ...
      public void Write(TProtocol oprot) {
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            {
              oprot.WriteListBegin(new TList(TType.Struct, Success.Count));
              foreach (TokenRange _iter119 in Success)
              {
